...
export type SearchBarProps = {
    ...
    /**
     * Fires when the user submits (Enter key or Search button).
 ...
 * SearchBar
 *
 * A pill-shaped search input with an inline clear button, a Search action
 * button, and an optional suggestions dropdown with highlighted matches.
 *
 * @example
 * <SearchBar
 *   placeholder="Search posts, food, tips…"
 *   suggestions={[
 *     { id: "1", label: "Siomai rice", sublabel: "Food · Gate 2", icon: "🍱" },
 *     { id: "2", label: "Study tips", sublabel: "Tips · pinned",  icon: "📍" },
 *   ]}
 *   onSearch={(q) => console.log("search:", q)}
 *   onSuggestionSelect={(s) => console.log("picked:", s)}
 * />
 */
